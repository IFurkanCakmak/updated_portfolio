...
const SingleProject = ({title, backgroundImg, projectUrl, description}) => {
  return (
    <div className="relative flex items-center justify-center h-auto w-full mt-5 shadow-xl shadow-gray-800 rounded-xl p-4 group hover:bg-gradient-to-r from-teal-400 to-teal-600  ">
      <Image
      ...
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        ...
        <p className="pb-4 pt-2 text-lg font-semibold text-center text-white">{description}</p>
