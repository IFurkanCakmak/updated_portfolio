    ...
    <div className="w-full lg:h-screen md:h-screen bg-black/90 backdrop-blur-lg">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <p className="py-2 text-2xl lg:text-5xl font-semibold"> Real Estate Web App</p>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          <p className="text-xl lg:text-2xl text-teal-400 tracking-widest'">PROJECT</p>
        ...
        <div className="p-2">
          ...
          <div className="grid grid-cols-3 md:grid-cols-1">
            <p className="py-2 flex items-center font-semibold"><RiRadioButtonFill className="mt-1 pr-1 text-teal-600"/>Next</p>
            <p className="py-2 flex items-center font-semibold"><RiRadioButtonFill className="mt-1 pr-1 text-teal-600"/>Next</p>
            <p className="py-2 flex items-center font-semibold"><RiRadioButtonFill className="mt-1 pr-1 text-teal-600"/>Next</p>
            <p className="py-2 flex items-center font-semibold"><RiRadioButtonFill className="mt-1 pr-1 text-teal-600"/>Next</p>
            <p className="py-2 flex items-center font-semibold"><RiRadioButtonFill className="mt-1 pr-1 text-teal-600"/>Next</p>
